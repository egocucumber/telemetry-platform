...
const (
	IngestService_Publish_FullMethodName      = "/telemetry.v1.IngestService/Publish"
	IngestService_PublishBatch_FullMethodName = "/telemetry.v1.IngestService/PublishBatch"
)
...
func (c *ingestServiceClient) Publish(ctx context.Context, opts ...grpc.CallOption) (grpc.BidiStreamingClient[PublishRequest, PublishResponse], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &IngestService_ServiceDesc.Streams[0], IngestService_Publish_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
...
type IngestService_PublishClient = grpc.BidiStreamingClient[PublishRequest, PublishResponse]

func (c *ingestServiceClient) PublishBatch(ctx context.Context, in *PublishBatchRequest, opts ...grpc.CallOption) (*PublishBatchResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(PublishBatchResponse)
	err := c.cc.Invoke(ctx, IngestService_PublishBatch_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedIngestServiceServer) Publish(grpc.BidiStreamingServer[PublishRequest, PublishResponse]) error {
	return status.Error(codes.Unimplemented, "method Publish not implemented")
}
func (UnimplementedIngestServiceServer) PublishBatch(context.Context, *PublishBatchRequest) (*PublishBatchResponse, error) {
...
func _IngestService_Publish_Handler(srv interface{}, stream grpc.ServerStream) error {
	return srv.(IngestServiceServer).Publish(&grpc.GenericServerStream[PublishRequest, PublishResponse]{ServerStream: stream})
}

// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type IngestService_PublishServer = grpc.BidiStreamingServer[PublishRequest, PublishResponse]

func _IngestService_PublishBatch_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(PublishBatchRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(IngestServiceServer).PublishBatch(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: IngestService_PublishBatch_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(IngestServiceServer).PublishBatch(ctx, req.(*PublishBatchRequest))
	}
...
var IngestService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "telemetry.v1.IngestService",
	HandlerType: (*IngestServiceServer)(nil),
	Methods: []grpc.MethodDesc{
		{
			MethodName: "PublishBatch",
			Handler:    _IngestService_PublishBatch_Handler,
		},
	},
	Streams: []grpc.StreamDesc{
		{
			StreamName:    "Publish",
			Handler:       _IngestService_Publish_Handler,
			ServerStreams: true,
			ClientStreams: true,
		},
	},
